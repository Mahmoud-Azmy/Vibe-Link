    ...
    return BlocConsumer<RestPasswordCubit, RestPasswordState>(
      listener: (context, state) {
        ...
        if (state is Success) {
          ...
          showSuccessDialog(
            context: context,
            message: S.of(context).emailResetSentMessage,
            title: S.of(context).emailResetSent,
          ...
          child: Column(
            ...
            children: [
              GradientText(
                ...
                text: S.of(context).typeYourEmail.toUpperCase(),
                textStyle: AppTextStyles.font18Bold,
              ),
              SizedBox(height: 16.h),
              CustomContainerMessage(message: S.of(context).typeYourEmail),
